...
class DoctrineGreenObjectImageRepository extends DoctrineRepository implements GreenObjectImagesRepository
{
    ...
    /**
     * @param GreenObjectImage $greenObjectImageImage
     */
    public function update(GreenObjectImage $greenObjectImageImage)
    {
        $this->getEntityManager()->merge($greenObjectImageImage);
