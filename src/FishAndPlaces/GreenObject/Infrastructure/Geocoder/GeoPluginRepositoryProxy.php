...
class GeoPluginRepositoryProxy implements LocalGeoPluginRepository
{
    ...
    public function nearby($radius=10, $limit=null)
    {
        ...
        $host = "http://www.geoplugin.net/extras/nearby.gp?lat=" . $this->latitude . "&long=" . $this->longitude . "&Aradius={$radius}";
