...
class UpdateCampCommand extends UpdateGreenObjectCommand
{
     ...
     */
    public function __construct(CampRepresentation $greenObjectRepresentation, User $user , $fileName = null)
    {
        parent::__construct($greenObjectRepresentation, new Camp(), $user, $fileName);
    }
}
